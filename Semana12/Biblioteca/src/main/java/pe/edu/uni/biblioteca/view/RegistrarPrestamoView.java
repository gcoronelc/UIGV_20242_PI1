...
import pe.edu.uni.biblioteca.controller.BibliotecaController;
...
import pe.edu.uni.biblioteca.util.Mensaje;
...
public class RegistrarPrestamoView extends javax.swing.JInternalFrame {
	...
	EstudianteDto beanEstudiante = null;
   ...
   private void initComponents() {
      ...
      btnProceso.setBackground(new java.awt.Color(153, 255, 204));
      ...
      jPanel1Layout.setHorizontalGroup(
         ...
         .addGroup(jPanel1Layout.createSequentialGroup()
            .addGap(16, 16, 16)
            .addComponent(btnProceso, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
      ...
      jPanel1Layout.setVerticalGroup(
         ...
         .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               .addComponent(btnProceso, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
   ...
   private void txtCodigoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyReleased
		...
		beanEstudiante = consultaController.consultarEstudiante(codigo);
		if (beanEstudiante == null) {
			return;
		}
		String nombre = beanEstudiante.getNombre() + ", " + beanEstudiante.getApellido();
   ...
   private void btnProcesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesoActionPerformed
      // Validar estudiante
		if(beanEstudiante==null){
			Mensaje.error(this, "Debe ingresar el estudiantes.");
			return;
		}
		// Validar ejemplar
		int fila = tblEjemplares.getSelectedRow();
		if(fila==-1){
			Mensaje.error(this, "Debe seleccionar el ejemplar.");
			return;
		}
		try {
			// Dato
			Long idEstudiante = beanEstudiante.getIdestudiante();
			Long idEjemplar = Long.parseLong(tblEjemplares.getValueAt(fila, 0).toString());
			PrestamoDto dto = new PrestamoDto();
			dto.setIdEstudiante(idEstudiante);
			dto.setIdEjemplar(idEjemplar);
			// Proceso
			BibliotecaController controller = new BibliotecaController();
			controller.registrarPrestamo(dto);
			// Reporte
			Mensaje.info(this, "Proceso ejecutado correctamente.");
			limpiarFormulario();
		} catch (Exception e) {
			String msg = "Error en el proceso. " + e.getMessage();
			Mensaje.error(this, msg);
		}
